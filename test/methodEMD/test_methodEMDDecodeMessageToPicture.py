...
class MethodEMDDecodeMessageToPictureTest(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        print('In setUpClass() MethodEMDDecodeMessageToPicture')
        cls.emd = utils.import_module("emd", "dfstego/methods/methodEMD.py")

    @classmethod
    def tearDownClass(cls):
        print('In tearDownClass() MethodEMDDecodeMessageToPicture')
        del cls.emd
    ...
    def test_decode_message_to_picture_image_correct(self):
        ...
        self.assertEqual(self.emd.decode_message_to_picture(self.name_image),message)
